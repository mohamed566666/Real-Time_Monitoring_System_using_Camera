...
class Settings(BaseSettings):
    ...
    FACE_DETECTION_MODEL: Optional[str] = (
        "../models/res10_300x300_ssd_iter_140000.caffemodel"
    )
    FACE_RECOGNITION_MODEL: Optional[str] = (
        "../models/MobileFaceNet/weights/mobilefacenet.onnx"
    )
    FACE_DETECTION_CONFIDENCE: Optional[float] = 0.55
    FACE_RECOGNITION_THRESHOLD: Optional[float] = 0.55
